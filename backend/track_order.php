...
try {
    // Fetch the order details based on the provided order_id
    $stmt = $pdo->prepare("SELECT o.order_id, o.status, o.delivery_address, o.created_at, o.estimated_delivery
                           FROM orders o
                           WHERE o.order_id = ?");
